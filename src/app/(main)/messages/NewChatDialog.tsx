...
export default function NewChatDialog({
  ...
  const serachInputDebounce = useDebounce(searchInput);
  ...
  const { data, isFetching, isError, isSuccess, status } = useQuery({
    queryKey: ["stream-users", serachInputDebounce],
    queryFn: async () =>
      client.queryUsers(
        {
          ...
          ...(serachInputDebounce
            ? {
                $or: [
                  { name: { $autocomplete: serachInputDebounce } },
                  { username: { $autocomplete: serachInputDebounce } },
                ],
              }
            : {}),
        },
